        ...
        <div className="space-y-5 md:space-y-6">
            <div>
                <div className="text-[11px] uppercase tracking-[0.2em] font-bold text-white/50 mb-2">
                    Books · Papers · Influences
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Reading</h2>
            ...
            <p className="text-sm md:text-base text-white/60 leading-relaxed font-light">
                The books, papers, and ideas that have shaped how I see organisations, behaviour, and
            ...
            <div className="glass-frontstage rounded-xl border border-[var(--line-thinking)]/20 p-8 md:p-10 flex flex-col items-center text-center gap-4">
                ...
                >
                    <BookOpen className="w-6 h-6" style={{ color: 'var(--line-thinking)' }} strokeWidth={1.5} />
                </div>
                <div>
                    <p className="text-sm font-semibold text-white/80 mb-1">Reading list coming soon</p>
                    <p className="text-xs text-white/40 leading-relaxed max-w-xs">
                        Curating the titles and ideas worth sharing. Coming soon.
                    </p>
                </div>
            </div>
        </div>
